  ...
  render() {
    return (
      ...
      <div className="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
        ...
        <div className="rounded-3xl border-2 border-gray-200 p-4 lg:p-8 grid grid-cols-12 mb-8 max-lg:max-w-lg max-lg:mx-auto gap-y-4">
          ...
          <div className="col-span-12 lg:col-span-10 detail w-full lg:pl-3">
            ...
            <p className="font-normal text-base leading-7 text-gray-500 mb-6">
              Introducing our sleek round white portable speaker, the epitome of style and sound! Elevate your auditory experience with this compact yet powerful device that delivers crystal-clear audio wherever you go. <a href="#" className="text-indigo-600">More....</a>
            </p>
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-4">
                ...
                {/* Quantity input */}
                {/* <input type="text" id="number" className="border border-gray-200 rounded-full w-10 aspect-square outline-none text-gray-900 font-semibold text-sm py-1.5 px-3 bg-gray-100 text-center" value={quantity} onChange={handleQuantityChange} /> */}
        ...
        {/* Second product (similar structure) */}
        {/* Subtotal */}
        <div className="flex flex-col md:flex-row items-center md:items-center justify-between lg:px-6 pb-6 border-b border-gray-200 max-lg:max-w-lg max-lg:mx-auto">
          ...
          <div className="flex items-center justify-between gap-5 ">
            ...
            {/* <h6 className="font-manrope font-bold text-3xl lead-10 text-indigo-600">${price * quantity}</h6> */}
          </div>
        </div>
        {/* Checkout button */}

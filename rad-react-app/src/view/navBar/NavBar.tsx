          ...
          <div className="flex w-full flex-wrap items-center justify-between px-3">
            ...
            <div className="relative flex items-center">
              ...
              <div className="relative">
                ...
                {/* First dropdown menu */}
                <ul className="absolute z-[1000] float-left m-0 hidden min-w-max list-none overflow-hidden rounded-lg border-none bg-white bg-clip-padding text-left text-base shadow-lg dark:bg-surface-dark">
